...
As the data set is fairly large, there's a number of different things one might focus on. After spending some time reading about bee colonies and also looking at this specific data set, the thing that marked my interest the most was the relationship between honey production and number of colonies through time. The questions I find most relevant regarding that would be the following: 
...
This will be a simple exploratory data analysis on the production of honey in the U.S. 
